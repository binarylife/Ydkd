 ...
 */
public class PaiWorkerListActivity extends BackBaseActivity implements IMainView, View.OnClickListener {
  // 用户账号
  ...
  public static void startAction(Activity activity) {
    Intent intent = new Intent(activity, PaiWorkerListActivity.class);
